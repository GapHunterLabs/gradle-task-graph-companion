package dev.gaphunter.gradletaskgraphcompanion.review
 ...
 * that runs automatically when the tool window first opens. Counts
...
object ReviewPrompt {
    ...
    private const val KEY_HIT_COUNT = "dev.gaphunter.gradletaskgraphcompanion.review.hitCount"
    private const val KEY_ANSWERED = "dev.gaphunter.gradletaskgraphcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Gradle Task Graph Companion"
